...
else if ( _games[index[1]-x].bust >2  && _games[index[2]-x].bust >2 && games[index[3]-x].bust >2)
{
    engine.placeBet(1*100,  Math.round(2*100));
console.log("Predict next game : " + _games[index[1]-x].bust  );
}
